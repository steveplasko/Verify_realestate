...
public class RulesDialog extends Dialog {
	...
	private HashMap<String, List<RulesCheck>>  rulesDetail=null;
	 ...
	 * @param client 
	 */
	public RulesDialog(Shell arg0, HashMap<String, List<RulesCheck>> rulesDetail, DbxClientV2 client, String key) {
	 ...
	 * @param arg1
	 */
	public RulesDialog(Shell arg0, int arg1) {
		super(arg0, arg1);
	...
	public void initWidgets(){
		...
		// tabs
		RulesData data=new RulesData(rulesDetail);
		row=data.getData();
...
//		table.setFont(font);
		...
		saveButton.addSelectionListener( new SelectionAdapter(){
			public void widgetSelected(SelectionEvent e){
					if (e.getSource() == RulesDialog.this.saveButton){
						RulesDialog.this.saveAll();
						RulesDialog.this.askQuit();	
					}
